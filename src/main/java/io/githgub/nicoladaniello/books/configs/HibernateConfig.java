...
import io.githgub.nicoladaniello.books.BooksApplication;
...
/**
 * Configuring Hibernate Multi-tenancy feature.
 *
...
public class HibernateConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        em.setPackagesToScan(BooksApplication.class.getPackage().getName());
